...
<html lang="en">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        setInterval(function () {
          $('#time').html(''+moment().format('dddd, Do MMM YYYY, h:mm:ss'));
        }, 1000);
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="<?php echo base_url('assets/logo.png'); ?>" alt="" style="max-height:30px"></a>
    </div>
        ...
        <li><a href="#"><span id="time"></span></a></li>
          ...
          <div class="col-md-3">
            ...
            <div class="thumbnail" style="padding:15px;text-align:center;">
                <button class="btn btn-primary btn-block launch-modal" data-toggle="modal" data-target="#myModal1">
